...
file_put_contents('../update-test-source/finished.html','<!DOCTYPE html><html><head><title>Finished</title></head><body>You should be sent here on finish</body></html>');
...
files:
        add:
            ...
            - {local: "finished.html", remote: "finished.html"}
        delete:
            - "test3.txt"
scripts:
    do:
